 ...
 */
class getDoctrine_Orm_DefaultEntityManagerService extends App_Symfony_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver([(\dirname(__DIR__, 4).'/src/Persistence/Resources/mapping') => 'App\\Domain\\Model']);
        $c->setGlobalBasename('mapping');

        $b->addDriver($c, 'App\\Domain\\Model');

        $a->setEntityNamespaces(['Model' => 'App\\Domain\\Model']);
